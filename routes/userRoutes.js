...
const {authController,userController,productController,homeController} = require('../controllers/user/index')
...
router.get('/home',auth.requireLogin,auth.isUserBlocked,homeController.showHome)
